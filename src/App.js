  ...
  return (
    <div className="signup-form">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button onClick={handleSubmitLogin} type="submit" className="action-button">Sign In</button>
        <button onClick={handleSubmitUpdate} type="submit" className="action-button">Update Password</button>
      </form>
    </div>
  );
}
